...
Feature: When an user needs to authenticate
  ...
  Scenario: When an user needs to register for a new token
    ...
    Given I am on "https://gssp.stepup.example.com/app_dev.php/demo/sp"
    ...
    Then I should be on "https://gssp.stepup.example.com/app_dev.php/authentication"
    Given I press "Authenticate user"

    # The SSO return page
    Then I should be on "https://gssp.stepup.example.com/app_dev.php/saml/sso_return"
