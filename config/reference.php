 ...
 *     registration_route: scalar|null|Param, // Application route name to do the registration
 *     authentication_route: scalar|null|Param, // Application route name to do the authentication
 * }
